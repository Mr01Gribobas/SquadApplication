...
namespace SquadServer.Migrations
{
    ...
    [Migration("20260603131416_AddChats")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatModelEntityUserModelEntity", b =>
                {
            ...
            modelBuilder.Entity("SquadServer.Models.ModelsEntity.ChatModelEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("DateCreatedChat")
            ...
            modelBuilder.Entity("SquadServer.Models.ModelsEntity.MessageModelEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ChatModelEntityUserModelEntity", b =>
                {
                    b.HasOne("SquadServer.Models.ModelsEntity.ChatModelEntity", null)
                        .WithMany()
                        .HasForeignKey("ChatsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SquadServer.Models.UserModelEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SquadServer.Models.ModelsEntity.MessageModelEntity", b =>
                {
                    b.HasOne("SquadServer.Models.ModelsEntity.ChatModelEntity", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SquadServer.Models.UserModelEntity", "Sender")
                        .WithMany()
